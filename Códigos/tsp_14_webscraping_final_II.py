...
def desplegar_resultados(palabras,sitio):
    conteo  =[elemento[1] for elemento in palabras][::-1]#Obtenemos el valor del diccionario elemento e invertimos la lista
    palabra =[elemento[0] for elemento in palabras][::-1] #Obtenemos la clave del diccionario elemento e invertimos la lista
    plt.figure(figsize=(10,5))
    plt.bar(palabra,conteo)
    plt.title('Análisis del sitio: {}'.format(sitio),fontsize=24)
